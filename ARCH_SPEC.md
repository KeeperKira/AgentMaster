...
| # | Шаг | Описание |
|---|---|---|
| 1 | vcpkg + зависимости | Подключить ImGui, ImNodes, nlohmann-json через vcpkg |
| 2 | ImGui + Win32 | Интегрировать ImGui в существующее Win32 окно |
| 3 | ImNodes | Подключить и инициализать ImNodes |
| 4 | Классы Node и производные | Node, InputNode, OutputNode, TextNode, TripletNode, RouterNode |
| 5 | AgentModel | Хранение, создание, удаление, сериализация |
| 6 | Каркас UI | Две панели: каталог + canvas |
| 7 | Каталог | Список инструментов с drag (Input/Output скрыты) |
| 8 | Создание узлов | Drop на canvas → создание Node через AgentModel |
| 9 | Порты и связи | Отрисовка через ImNodes |
| 10 | Удаление | Красный крестик на узле (блокировка для Input/Output) |
| 11 | Zoom/Pan | Колёсико + средняя кнопка мыши |
| 12 | JSON экспорт | Сериализация через nlohmann/json |
| 13 | Полировка | Финальные штрихи |
